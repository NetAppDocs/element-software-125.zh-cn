...
[role="lead"]
https://mysupport.netapp.com/site/tools/tool-eula/element-demonode/download["Element 演示节点"^]是Element软件的VMware虚拟机(VM)版本、可用于轻松演示NetApp HCI和SolidFire产品的许多关键存储功能。开发人员可以通过演示节点根据 Element API 编写代码，而无需使用物理硬件。它会打包为 OVA 文件，以便于 VMware 部署。
